...
export function ClienteCadastroForm({ mode, clientId }: ClienteCadastroFormProps) {
  ...
  const allSteps = [
    ...
    { id: "endereco", label: "Endereço & Contato", icon: "pi pi-map-marker", fields: ["email", "receberNotificacoes", "canaisPreferidos", "telefoneCelular1", "telefoneCelular2", "cep", "endereco", "numero", "complemento", "bairro", "cidade", "uf", "pontoReferencia", "rendaFamiliar"] },
