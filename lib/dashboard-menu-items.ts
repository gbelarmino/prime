...
export const DASHBOARD_MENU_ITEMS: (MenuLinkItem | MenuGroupItem)[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "wa-modelos", href: "/dashboard/whatsapp/modelos", label: "Modelos de mensagem", icon: FileText, roles: ["ADMIN", "ADMINISTRATIVO"] },
      { id: "wa-gatilhos", href: "/dashboard/whatsapp/gatilhos", label: "Gatilhos automáticos", icon: Zap, roles: ["ADMIN", "ADMINISTRATIVO"] },
      { id: "wa-teste", href: "/dashboard/whatsapp/teste", label: "Teste", icon: Send, roles: ["ADMIN", "ADMINISTRATIVO"] },
      { id: "wa-teste-eventos", href: "/dashboard/whatsapp/teste-eventos", label: "Teste eventos", icon: FlaskConical, roles: ["ADMIN", "ADMINISTRATIVO"] },
